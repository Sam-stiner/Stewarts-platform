...
#define MUTE_BUTTON  0xffcc0001
#define STANDBY_ON 0xffcc0010 //0 
#define VOL_UP 0xffcc0021
#define VOL_DOWN 0xffcc0024
#define DVD 0xffcc002d  //red
#define TV 0xffcc002e   //green
#define GAME 0xffcc002f  //yellow
#define CD 0xffcc0030     //blue
...
void getrxp(float pe[])
{
   for(int i=0;i<6;i++)
   {
      rxp[0][i] = T[0]+M[0][0]*(re[0][i]);
      rxp[0][i] += M[0][1]*(re[1][i])+M[0][2]*(re[2][i]);
